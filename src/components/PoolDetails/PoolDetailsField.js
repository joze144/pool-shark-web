...
const PoolDetailsField = ({address, name, rate, deadline, amount_eth_collected, amount_points_collected, current_shark, creator}) => (
  <div className="middle-banner-container border-top border-bottom">
    <div className="inline-half pl-3 pr-3 border-left">
      <h5 className="dark-blue-text text-center text-shadow-gray border-bottom">Pool Details</h5>
      <div className="pl-3">
    ...
    <div className="inline-half pl-3 pr-3 border-left">
      <h5 className="dark-blue-text text-center text-shadow-gray border-bottom">Contribution Details</h5>
      <div className="pl-3">
